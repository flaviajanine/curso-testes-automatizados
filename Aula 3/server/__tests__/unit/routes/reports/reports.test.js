...
const CloudantMock = require('../../../../__mocks__/cloudantMock');

const app = new express();
app.use('/', routes);

jest.doMock('@ibm-cloud/cloudant', () => {
    const mockCloudant = new CloudantMock();
        return mockCloudant.start();
});

describe('Unit test in routes', () => {
